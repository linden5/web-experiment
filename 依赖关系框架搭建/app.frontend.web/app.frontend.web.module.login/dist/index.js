...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Login", function() { return __WEBPACK_IMPORTED_MODULE_0__components_Login__["a"]; });


const components = [
  __WEBPACK_IMPORTED_MODULE_0__components_Login__["a" /* default */]
]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Login_vue__ = __webpack_require__(0);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9fcfedee_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(8);
...
// module
exports.push([module.i, "\n.login-page[data-v-9fcfedee] {\n  padding: 10px;\n}\ninput[data-v-9fcfedee] {\n  margin: 5px;\n  height: 2em;\n  line-height: 2em;\n  border: 1px solid #ddd;\n  border-radius: 5px;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "header-page login-page" },
    [
      _c("NavHeaderBar"),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            "h2",
            [
              _c("van-icon", { attrs: { name: "contact" } }),
              _vm._v("\n      欢迎回来\n    ")
            ],
            1
          ),
      ...
      _c(
        ...
        [
          _c("h2", [_vm._v("您好," + _vm._s(_vm.username))]),
          _vm._v(" "),
          _c(
            "van-button",
            {
              attrs: { type: "primary", "bottom-action": "" },
              on: {
                click: function($event) {
                  _vm.logout()
                }
